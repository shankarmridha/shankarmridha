...
const clients = [
  ...
  { name: "Federal Bank", sector: "BFSI", logo: "/logos/federal-bank.png", fallback: "" },
  { name: "Generali Central", sector: "BFSI", logo: "/logos/generali-central.jpg", fallback: "" },
  { name: "Central Bank of India", sector: "BFSI", logo: "/logos/central-bank.png", fallback: "" },
  // Automobile
  ...
  { name: "Mahindra Automobiles", sector: "Automobile", logo: "/logos/mahindra.png", fallback: "" },
  { name: "Hyundai", sector: "Automobile", logo: "/logos/hyundai.jpg", fallback: "" },
  { name: "Driv India", sector: "Automobile", logo: "/logos/driv-india.jpg", fallback: "" },
  // Oil & Gas
  ...
  { name: "Total Energies", sector: "Oil & Gas", logo: "/logos/total-energies.jpg", fallback: "" },
  { name: "Reliance BP Mobility", sector: "Oil & Gas", logo: "/logos/reliance-bp.png", fallback: "" },
  { name: "SBM Offshore", sector: "Oil & Gas", logo: "/logos/sbm-offshore.png", fallback: "" },
  // FMCG
  ...
  { name: "Eaton", sector: "Manufacturing", logo: "/logos/eaton.jpg", fallback: "" },
  { name: "Vardhaman", sector: "Manufacturing", logo: "/logos/vardhaman.png", fallback: "" },
  ...
  { name: "DNV", sector: "Professional Services", logo: "/logos/dnv.jpg", fallback: "" },
  // IT
  ...
  { name: "ITC Infotech", sector: "IT", logo: "/logos/itc-infotech.jpg", fallback: "" },
  { name: "Analytix", sector: "IT", logo: "/logos/analytix.png", fallback: "" },
  { name: "Zensar Technologies", sector: "IT", logo: "/logos/zensar.png", fallback: "" },
  { name: "Ingram Micro", sector: "IT", logo: "/logos/ingram-micro.jpg", fallback: "" },
  { name: "ASAP Solutions Pvt. Ltd.", sector: "IT", logo: "", fallback: "" },
  { name: "Volkswagen IT", sector: "IT", logo: "", fallback: "" },
  { name: "uKnowva", sector: "IT", logo: "/logos/uknowva.jpg", fallback: "" },
  // Real Estate
  ...
  { name: "Gera Builders", sector: "Real Estate", logo: "/logos/gera-builders.png", fallback: "" },
  // Media
  { name: "Sakal Media Group", sector: "Media", logo: "/logos/sakal.jpg", fallback: "" },
  { name: "Times of India", sector: "Media", logo: "/logos/times-of-india.jpg", fallback: "" },
  // Power
  { name: "Tata Power Renewable Energy", sector: "Power", logo: "/logos/tata-power.jpg", fallback: "" },
  { name: "Tata Power - NPL", sector: "Power", logo: "/logos/tata-power.jpg", fallback: "" },
  // Education
  ...
  { name: "IBS College", sector: "Education", logo: "/logos/ibs-college.png", fallback: "" },
  { name: "ISBM College", sector: "Education", logo: "/logos/isbm-college.png", fallback: "" },
  { name: "Bricks Architecture College Pune", sector: "Education", logo: "/logos/bricks-architecture-college.png", fallback: "" },
  { name: "Shivaji College Kolhapur", sector: "Education", logo: "/logos/shivaji-college.jpg", fallback: "" },
  { name: "Amanora School", sector: "Education", logo: "/logos/amanora-school.jpg", fallback: "" },
  { name: "Times Education", sector: "Education", logo: "/logos/times-education.png", fallback: "" },
  { name: "ICSI", sector: "Education", logo: "/logos/icsi.png", fallback: "" },
  // Retail
  { name: "Somerfield Stores UK", sector: "Retail", logo: "/logos/somerfield-stores.png", fallback: "" },
  { name: "Marks & Spencer UK", sector: "Retail", logo: "/logos/marks-and-spencer.jpg", fallback: "" },
  // Telecom
  { name: "Reliance Jio", sector: "Telecom", logo: "/logos/reliance-jio.png", fallback: "" },
  { name: "Sprint USA", sector: "Telecom", logo: "/logos/sprint.png", fallback: "" },
  // Govt
  { name: "Netherland Embassy", sector: "Govt", logo: "/logos/netherlands-embassy.jfif", fallback: "" },
  // Others
  { name: "CABWW", sector: "Others", logo: "/logos/cabww.png", fallback: "" },
];
